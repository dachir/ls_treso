...
def create_missing_invoices(doc):
    ...
    # A Purchase Invoice validates Due Date against Bill Date when it exists.
    # For invoices generated by LS Tréso there is no external supplier bill date,
    # so use the operation date consistently for posting, bill and due dates.
